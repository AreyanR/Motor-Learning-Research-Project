...
expName = 'animation'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Max Hoac\\Desktop\\Areyan\\motor-learning-research-project\\Animation\\animation_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    frame_paths = ['dino_frames/f1.png', 'dino_frames/f2.png', 'dino_frames/f3.png', 
                   'dino_frames/f4.png', 'dino_frames/f5.png', 'dino_frames/f6.png', 
                   'dino_frames/f7.png', 'dino_frames/f8.png', 'dino_frames/f9.png', 
                   'dino_frames/f10.png', 'dino_frames/f11.png', 'dino_frames/f12.png']
    ...
    while continueRoutine:
        ...
        # Ensure `frame_index` is updated every X frames (e.g., every 2 frames)
        if (frame_index_update_counter % 4) == 0:  # Adjust 2 to control speed
            ...
            if frame_index >= total_frames:
                frame_index = 0  # Loop back to the start
